  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <!-- Content_top moved above tabs so the secondary menus are above the tabs -->    
            
        <?php print $content_top; ?>

        <!-- messages moved below Content_top so that the secondary menus don't separate from the titles -->    

	<?php if ($front_left): ?>
        <div id="frontleft"><?php print $front_left; ?></div>
        <?php endif; ?>

	<?php if ($front_right): ?>
        <div id="frontright"><?php print $front_right; ?></div>
        <?php endif; ?>
